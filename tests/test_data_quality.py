        ...
        return pd.DataFrame(
            {
                ...
                "sales_channel": [
                    "Internet", "Internet", "Mobile", "Internet", "Internet",
                    "Mobile", "Internet", "Mobile", "Internet", "Internet",
                ],
                "trip_type": [
                    "RoundTrip", "OneWay", "RoundTrip", "CircleTrip", "RoundTrip",
                    "OneWay", "RoundTrip", "RoundTrip", "OneWay", "RoundTrip",
                ],
                ...
                "route": [
                    "JFKLAX", "LAXSFO", "ORDJFK", "JFKLAX", "SFOJFK",
                    "JFKLAX", "LAXSFO", "ORDJFK", "JFKLAX", "SFOJFK",
                ],
                "booking_origin": [
                    "United States", "Australia", "United Kingdom", "Australia",
                    "New Zealand", "United States", "India", "Australia",
    ...
    def test_empty_dataframe(self):
        ...
        df = pd.DataFrame(
            columns=[
                ...
                "wants_in_flight_meals", "flight_day", "booking_complete",
            ]
        )
